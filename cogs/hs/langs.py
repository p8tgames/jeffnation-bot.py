...
guesss_strings = ["You are correct!", "Das ist richtig!, ''"]
guessf_strings = ["Sorry, the correct answer actually is {}.", "'Tschuldigung, die richtige Antwort war {}.", ""]
guessi_strings = ["Bruh put in a number you dork.", "Digger, du musst schon eine Nummer angeben!", ""]

howgayi_strings = ["you're {}% gay.", "du {}% schwul bist.", ""]
howgayyou_strings = ["{0} is {1}% gay.", "{0} {1}% schwul ist.", ""]
...
kick2 = ["Kicked user {}.", "Hab {} gekickt!", ""]
kick3 = ["Kicked user!", "Nutzer gekickt!", ""]
kicker = ["An error occured! Do you have perms to do that?", "Error! Hast du die Rechte dafür?", ""]


si1 = ["Server-Information of {}", "Server-Informationen von {}", ""]
si2 = ["You requested this Servers' Information.", "Du hast nach den Infos von diesem Server gefragt.", ""]
si3 = ["Information over.", "Information beendet.", ""]
si4 = ["Date created", "Erstelldatum", ""]
si5 = ["Members", "Mitglieder", ""]
si6 = ["AFK-Channel", "AFK-Kanal", ""]
si7 = ["Default-Role", "Standart-Rolle", ""]
si8 = ["Roles", "Rollen", ""]
...
hw = ["There are {} days left until halloween.", "Es verbleiben {} Tage bis Halloween!", ""]

avatar = ["Avatar of {}", "Profilbild von {}", ""]
avatarerror = ["You need to TAG someone, silly.", "Du musst jemanden MAKIEREN, Dummkopf.", ""]
